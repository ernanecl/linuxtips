...
# GitHub: https://github.com/badtuxx/DescomplicandoPrometheus/blob/main/pt/src/day-2/README.md#o-nosso-primeiro-exporter
# Open Notify - People in Space: http://open-notify.org/Open-Notify-API/People-In-Space/
